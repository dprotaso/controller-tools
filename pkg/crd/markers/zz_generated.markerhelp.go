...
/*
Copyright2022 The Kubernetes Authors.
...
func (DropProperties) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		Category: "CRD validation",
		DetailedHelp: markers.DetailedHelp{
			Summary: "marks that the resulting schema should omit child properties defintions. ",
			Details: "Typically this should be paired with PreserveUnknownFields",
		},
		FieldHelp: map[string]markers.DetailedHelp{},
	}
}
